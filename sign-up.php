    ...
    <section>
      ...
      <div class="navigation-bar">
        <div id="navigation-container">
          ...
          <ul>
          <li><a href="http://localhost/air-quality-project/index.php">Go back</a></li>
          </ul>
      </div>
          ...
          <div class="user singinBx">
            <div class="formBx">
                <form name = "addUser" action="signUp.php" method="POST">
                    ...
                    <p class="signup">Already have an account? <a href="http://localhost/air-quality-project/index.php">Log in</a></p>
                </form>
            </div>
