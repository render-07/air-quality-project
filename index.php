    ...
    <section>
      ...
      <div class="navigation-bar">
        <div id="navigation-container">
          ...
          <ul>
          <li><a href="http://localhost/air-quality-project/sign-up.php">Create an account</a></li>
    ...
    <div id="loginModal" class="modal fade">
      <div class="modal-dialog modal-login">
        <div class="modal-content">
          ...
          <p class="signup">Don't have an account ? <a href="http://localhost/air-quality-project/sign-up.php">Sign up</a></p>
          </div>
        </div>
      </div>   
    </body>
